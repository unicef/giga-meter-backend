...
async function bootstrap() {
  ...
  const defaultConfig = new DocumentBuilder()
    ...
    .setDescription(
      'API to query list schools and countries with Daily Check App installed and their raw measurements indicators like download speed, latency, upload speed etc.\n\n' +
