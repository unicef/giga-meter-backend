...
export class MeasurementService {
  ...
  private toDto(
    ...
    const filterMeasurementData = {
      ...
      device_cpu: measurement.device_cpu,
      device_ram_mb: measurement.device_ram_mb,
      device_storage_mb: measurement.device_storage_mb,
  ...
  private toModel(measurement: AddMeasurementDto): any {
    return {
      ...
      device_cpu: measurement.device_cpu ?? null,
      device_ram_mb: measurement.device_ram_mb ?? null,
      device_storage_mb: measurement.device_storage_mb ?? null,
