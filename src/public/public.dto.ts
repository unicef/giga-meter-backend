...
export class PublicSchoolDto {
  ...
  @ApiProperty({
    ...
    type: PublicGeoLocationDto,
  })
  geolocation?: PublicGeoLocationDto;
...
export class PublicClientInfoDto {
  @ApiProperty()
  IP?: string;

  @ApiProperty()
  ASN?: PublicASNDto | string;
...
export class PublicServerInfoDto {
  @ApiProperty()
  URL?: string;
...
class LastServerMeasurementDto {
  ...
  @ApiProperty({ type: PublicTCPInfoDto })
  TCPInfo: PublicTCPInfoDto;
}
...
export class PublicMeasurementDto {
  @ApiProperty()
  id?: string;
  ...
  @ApiProperty()
  ClientInfo?: PublicClientInfoDto;

  @ApiProperty()
  ServerInfo?: PublicServerInfoDto;
  ...
  @ApiProperty()
  Results?: PublicResultsDto | ResultsNdt7Dto;
