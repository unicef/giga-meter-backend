...
export class SchoolService {
  ...
  private toDto(school: School): SchoolDto {
    const geolocation =
      school.detected_latitude != null && school.detected_longitude != null
        ? {
            location: {
              lat: school.detected_latitude,
              lng: school.detected_longitude,
            },
            accuracy: school.detected_location_accuracy ?? undefined,
          }
        : undefined;
    ...
    return {
      ...
      geolocation,
      detected_location_distance: school.detected_location_distance ?? undefined,
      detected_location_accuracy: school.detected_location_accuracy ?? undefined,
      detected_location_is_flagged:
        school.detected_location_is_flagged ?? undefined,
  ...
  private toModel(school: SchoolDto): any {
    return {
      ...
      detected_location_accuracy:
        school.detected_location_accuracy || null,
      detected_location_distance:
        school.detected_location_distance || null,
      detected_location_is_flagged:
