/*
  ...
  - You are about to drop the column `os_version` on the `measurements` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `os_version` on the `measurements_failed` table. All the data in the column will be lost.
